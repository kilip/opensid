    ...
    <div class="w-full h-20 px-6 bg-gray-100 border-b flex items-center justify-between">
      ...
      <div class="flex">
        ...
        <div class="inline-block lg:hidden flex items-center mr-4">
          <button class="hover:text-blue-500 hover:border-white focus:outline-none navbar-burger" v-on:click="toggleSidebar">
        ...
        <div class="relative text-gray-600">
          <input type="search" name="search" placeholder="Search products..." class="bg-white h-10 w-full xl:w-64 px-5 rounded-lg border text-sm focus:outline-none">
