...
import KategoriForm from './Form.vue';
...
export default {
  ...
  computed: {
    ...
    ...mapFields('kategori/create', {
      created: 'created',
    }),
    ...mapFields('kategori/update', {
      isLoading: 'isLoading',
      error: 'error',
      retrieved: 'retrieved',
      updated: 'updated',
  ...
  watch: {
    ...
    deleted: function(deleted) {
      ...
      this.$router.push({ name: 'KategoriList' });
    },
  },
  ...
  methods: {
    ...mapActions({
      createReset: 'kategori/create/reset',
      deleteItem: 'kategori/del/del',
      delReset: 'kategori/del/reset',
      retrieve: 'kategori/update/retrieve',
      updateReset: 'kategori/update/reset',
      update: 'kategori/update/update',
      updateRetrieved: 'kategori/update/updateRetrieved',
    }),
