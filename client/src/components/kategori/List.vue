<template>
  <div>
      ...
      <tbody>
        <tr
          ...
          <th scope="row">
            <router-link
              v-if="item"
              :to="{name: 'KategoriShow', params: { id: item['@id'] }}">
              {{ item['@id'] }}
            </router-link>
          </th>
        <td>
        ...
        <td>
          ...
          <td>
            <router-link :to="{name: 'KategoriUpdate', params: { id: item['@id'] }}">
              <span
                class="fa fa-pencil"
                aria-hidden="true"></span>
    ...
    <nav aria-label="Page navigation" v-if="view">
      <router-link
        :to="view['hydra:first'] ? view['hydra:first'] : 'KategoriContactList'"
      ...
      &nbsp;
      <router-link
        :to="!view['hydra:previous'] || view['hydra:previous'] === view['hydra:first'] ? 'KategoriList' : view['hydra:previous']"
        :class="{ disabled: !view['hydra:previous'] }"
        class="btn btn-primary">
