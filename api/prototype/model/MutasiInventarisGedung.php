...
class MutasiInventarisGedung
{
    ...
    public function getIdInventarisGedung(): ?InventarisGedung
    {
        return $this->idInventarisGedung;
    }

    public function setIdInventarisGedung(?InventarisGedung $idInventarisGedung): self
    {
        $this->idInventarisGedung = $idInventarisGedung;
