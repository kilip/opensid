...
class InventarisJalan
{
    ...
    public function getPanjang(): ?string
    {
        return $this->panjang;
    }

    public function setPanjang(string $panjang): self
    {
    ...
    public function getLebar(): ?string
    {
        return $this->lebar;
    }

    public function setLebar(string $lebar): self
    {
        $this->lebar = $lebar;
