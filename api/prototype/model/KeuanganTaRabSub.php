...
class KeuanganTaRabSub
{
    ...
    public function getNamaSubrinci(): ?string
    {
        return $this->namaSubrinci;
    }

    public function setNamaSubrinci(string $namaSubrinci): self
    {
        $this->namaSubrinci = $namaSubrinci;
