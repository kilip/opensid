...
class MutasiInventarisPeralatan
{
    ...
    public function getIdInventarisPeralatan(): ?InventarisPeralatan
    {
        return $this->idInventarisPeralatan;
    }

    public function setIdInventarisPeralatan(?InventarisPeralatan $idInventarisPeralatan): self
    {
        $this->idInventarisPeralatan = $idInventarisPeralatan;
