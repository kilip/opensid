...
class MutasiInventarisAsset
{
    ...
    public function getIdInventarisAsset(): ?InventarisAsset
    {
        return $this->idInventarisAsset;
    }

    public function setIdInventarisAsset(?InventarisAsset $idInventarisAsset): self
    {
        $this->idInventarisAsset = $idInventarisAsset;
